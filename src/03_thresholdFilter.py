...
write_dataOut = open("%s%s" % (r"02_output/","filteredTemporalData.csv"), 'w',newline='', encoding='utf-8')
writer_dataOut = csv.writer(write_dataOut)
writer_dataOut.writerow(["X","Y","Z"])

for x,y,z in zip(df_["LON"],df_["LAT"],df_["LSTF_SLOPE"]):
	writer_dataOut.writerow([x,y,z])
